...
curl http://localhost:8000/api/models/your-model-name/health
...
```bash
curl -X POST http://localhost:8000/api/models/your-model/staging \
...
GreenThread listens on port 8000 by default. If another process is using this port:
